...
public class Copia extends PedinaAstratta {
	
	public CasellaAstratta[][] matriceTabellone;
	
	public Copia(String nomePedina, Tabellone tabellone) {
	...
	/**
	 * Gestisce gli eventuali punti in eccesso della combinazione dei dadi facendo
	 * retrocedere la pedina di un certo numero di caselle.
	 * @param casellaCorrente Casella corrente
	 * @param combinazioneDadi Combinazione dei dadi
	 * @return Numero della casella raggiunta dopo aver indietreggiato di un certo
	 * numero di caselle
	 */
...
//			System.out.println("SONO OLTRE!!!");
	...
	private int manageRules(CasellaAstratta prossimaCasella) {
		...
		if(prossimaCasella.tipologiaCasella == TipologiaCasella.UNSOLODADADO) {
			nuovaCasella = nuovaCasella-getLancioDeiDadi()[1];
			return nuovaCasella;
		}
